...
const shippingSections = [
  {
    ...
    content: (
      <ul>
        ...
        <li>Orders are shipped on working days as wells as on weekends or holidays.</li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>Shipping is offered within India.</li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          Rachna is not responsible for any customs and taxes applied
          to your order.
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          Rachna is not liable for products damaged or lost during
          shipping.
        </li>
        <li>
    ...
    content: (
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <a href="mailto:aymnsk45@gmail.com">
            aymnsk45@gmail.com
          </a>
        </div>
        <div className="flex items-center gap-3">
          <Phone className="h-5 w-5 text-cyan-600" />
          <a href="tel:03152439846">+91 7718986445</a>
        </div>
      </div>
    ),
  },
        ...
        <div className="relative isolate overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
              ...
              what to expect with your Rachna order.
            </p>
          </div>
