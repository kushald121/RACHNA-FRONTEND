  ...
  const policySections = [
    {
      ...
      content: (
        <>
          ...
          <p>
            <strong>To start a return,</strong> please contact us at <a href="aymnsk45@gmail.com">aymnsk45@gmail.com</a>. If your return is accepted, we’ll send you a return shipping label and instructions. 
          </p>
          <p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>Please remember it can take some time for your bank or credit card company to process and post the refund too. If more than 15 business days have passed since we’ve approved your return, please contact us at <a href="aymnsk45@gmail.com">aymnsk45@gmail.com</a>.</p>
        </>
      ),
    },
            ...
            <div className="rounded-2xl bg-slate-50 p-8 ring-1 ring-slate-900/10 shadow-xl shadow-cyan-600/10">
                ...
                <div className="mt-8 space-y-5 text-gray-700">
                    <div className="flex items-center gap-4">
                      ...
                      <a href="aymnsk45@gmail.com" className="hover:underline">aymnsk45@gmail.com</a>
                    </div>
                  </div>
            </div>
        </div>
