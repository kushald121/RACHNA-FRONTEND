  ...
  <motion.div className="bg-white"
    ...
    <main className="py-60 sm:py-56">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
            {/* Home Page Button */}
            <motion.span variants={textMotion}>
                <Link to="/Rachna/" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-md hover:shadow-none hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Go back home
                </Link>
            </motion.span>
