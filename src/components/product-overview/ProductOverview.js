                      ...
                      <RadioGroup.Option
                        ...
                        className={({ active, checked }) =>
                          classNames(
                            size.inStock
                              ? checked
                                ? "cursor-pointer bg-indigo-600 text-white border-indigo-600 shadow-sm hover:bg-indigo-700"
                                : "cursor-pointer bg-white text-gray-900 border-gray-300 shadow-sm hover:bg-gray-50 hover:border-indigo-400"
                              : "cursor-not-allowed bg-gray-50 text-gray-200 border-gray-200",
                            active && size.inStock && !checked ? "ring-2 ring-indigo-500" : "",
                            "group relative flex items-center justify-center rounded-lg border py-3 px-4 text-sm font-medium uppercase focus:outline-none sm:flex-1 sm:py-6 transition-all duration-200"
                          )
                        }
                      >
                        {({ active, checked }) => (
